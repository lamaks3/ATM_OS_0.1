    ...
    public class CurrencyUpdateService
    {
        ...
        public static async Task PreloadRatesAsync()
        {
            try
            {
                ...
                _rates["USD_in"] = firstBranch.GetProperty("USD_in").GetString() ?? "?";
                _rates["USD_out"] = firstBranch.GetProperty("USD_out").GetString() ?? "?";
                _rates["EUR_in"] = firstBranch.GetProperty("EUR_in").GetString() ?? "?";
                _rates["EUR_out"] = firstBranch.GetProperty("EUR_out").GetString() ?? "?";
